[myfirsttssproject2-2ed5] Operating Details
====================================

Generated On: 2024-10-10 17:22:35 UTC
...
.. important::
   ...
   **not be valid if your [myfirsttssproject2-2ed5] container is NOT running**.

.. tip::
   You must have your [myfirsttssproject2-2ed5] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42165  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='aanthonylin'  \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env MQTTUSERNAME='aanthonylin'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   aanthonylin/myfirsttssproject2-2ed5-amd64 (https://hub.docker.com/r/aanthonylin/myfirsttssproject2-2ed5-amd64)
...
.. important::
   docker run -d -p 54151:54151 -p 37317:37317 -p 43481:43481 \-\-env TSS=0 \-\-env SOLUTIONNAME=myfirsttssproject2-2ed5 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myfirsttssproject2-2ed5 \-\-env GITUSERNAME=aanthonylin  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=54151  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=37317  \-\-env SOLUTIONVIPERVIZPORT=43481 \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env EXTERNALPORT=42165 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='aanthonylin' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  aanthonylin/myfirsttssproject2-2ed5-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=43481
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=54151
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - aanthonylin/myfirsttssproject2-2ed5-amd64
...
It can be accessed by entering: http://localhost:37317
...
.. important::
   http://localhost:43481/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:43481/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:43481/<html file>
...
[myfirsttssproject2-2ed5] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/aanthonylin/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfirsttssproject2-2ed5
...
.. important::
   https://myfirsttssproject2-2ed5.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myfirsttssproject2-2ed5
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=54151, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36321, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42139, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41757, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44733, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41751, HPDEHOST=127.0.1.1, HPDEPORT=35367, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39809

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2821-myfirsttssproject2-2ed5,solution_preprocessing_dag-myfirsttssproject2-2ed5, python-preprocess-2926-myfirsttssproject2-2ed5,solution_preprocessing_dag-myfirsttssproject2-2ed5, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
